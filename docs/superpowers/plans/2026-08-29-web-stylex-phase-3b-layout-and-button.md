...
| Selector                                                                          | Ruling                                                                                                                                                                                                                                                                          |
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `data-[slot=accordion-trigger-icon]:size-4`, `:ml-auto`, `:text-muted-foreground` | The icon styles itself. Render it as `<ChevronIcon {...stylex.props(icon.sm, styles.triggerIcon)} />` where `triggerIcon` carries `marginInlineStart: "auto"` and `color: colors.mutedForeground`.                                                                              |
...
| `[&_svg]:pointer-events-none`, `[&_svg]:shrink-0` |     2 | The icon styles itself — callers pass `{...stylex.props(icon.sm)}` to the icon they render inside the button. `icon` already carries both properties.                                  |
