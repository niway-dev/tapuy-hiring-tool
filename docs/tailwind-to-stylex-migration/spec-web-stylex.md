...
| D9  | Build route (official PostCSS plugin vs `unplugin-stylex`) is **chosen by the Phase 0 spike**, not by preference                                                                         | Both are viable on paper; SSR under Cloudflare is unverified for either                                               |
...
apps/
  ...
  web-stylex/                  copy of web + StyleX (this spec)
    src/
      ...
      stylex.css               "@stylex;" directive (PostCSS route) — spike decides
